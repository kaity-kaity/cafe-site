	...
	<section class="sec bg-gray">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					<a href="<?php echo get_permalink(52); ?>" class="bnr" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/home/bnr_about@2x.jpg')">
						<div class="bnr_inner">
				...
				<div class="col-md-6">
					<a href="<?php echo get_permalink(61); ?>" class="bnr" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/home/bnr_access@2x.jpg')">
						<div class="bnr_inner">
	...
	<section class="sec sec-bg">
		<div class="sec_inner">
			...
			<div class="sec_btn">
				<a href="?php echo home_url('/contact/'); ?>" class="btn btn-default">" class="btn btn-default">メールフォーム<i class="fas fa-angle-right"></i></a>
			</div>
		</div>
	</section>
	<?php get_footer(); ?> 